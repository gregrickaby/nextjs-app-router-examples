 ...
 *
 * Usage: https://nextjs-app-directory-testing.vercel.app/forcast/api/?location=Orlando,FL
 *
 * Note: Do not try to fetch this route from a server component!
 * This API is available for client-side components only. See:
 * https://github.com/vercel/next.js/discussions/46045#discussioncomment-5010898
 */
